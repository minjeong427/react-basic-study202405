...
const AuthContext = React.createContext({
  isLoggedIn: false,
  onLogout: () => {}, // 함수같은 경우에도 Context에 저장이 가능.
  onLogin: () => {}, // 초기화할 때 함수 내부를 굳이 선언할 필요는 없음.
});
...
export const AuthContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    console.log('useEffect 실행! - 최초 단 한 번만 실행됨!');
